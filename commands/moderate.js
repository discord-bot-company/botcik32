module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        let embed = new MessageEmbed().setColor(client.colors.beige).setDescription('Please choose an action.')
        ...
        collector.on('collect', async (i) => {
            if (i.customId === 'kick') {
                ...
                const embed1 = new MessageEmbed().setColor(client.colors.red).setDescription(`Successfully kicked ${member.toString()} for \`${reason}\``)
                ...
                const embed2 = new MessageEmbed().setColor(client.colors.red).setDescription(`Successfully banned ${member.toString()} for \`${reason}\``)
                ...
                const embed3 = new MessageEmbed().setColor(client.colors.red).setDescription(`Successfully muted ${member.toString()}.`)
                ...
                const embed4 = new MessageEmbed().setColor(client.colors.red).setDescription(`Successfully unmuted ${member.toString()}.`)
